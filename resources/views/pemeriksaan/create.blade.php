        ...
        <div class="card-body py-3 px-4 d-flex align-items-center justify-content-between flex-wrap gap-2 position-relative z-1">
            <div>
                <h5 class="mb-0 fw-bold text-white d-flex align-items-center gap-2">
                    <i class="bi bi-folder-plus"></i> Tambah Pemeriksaan Baru
                </h5>
                <div style="font-size:0.75rem; color:#94a3b8; margin-top:2px;">Buat entitas pemeriksaan induk baru</div>
            </div>
            ...
            <div class="card-body pt-3 pb-3">
                <div class="row g-3">
                    <div class="col-md-8">
                        ...
                        <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama') }}" required placeholder="Contoh: Pemeriksaan LKPD TA 2025">
                        @error('nama') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Tahun Anggaran <span class="text-danger">*</span></label>
                        <input type="text" name="tahun" class="form-control @error('tahun') is-invalid @enderror" value="{{ old('tahun', date('Y')) }}" required maxlength="4">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="form-check border rounded p-2" style="background:#f8fafc;">
                            <input class="form-check-input ms-1" type="checkbox" name="user_ids[]" value="{{ $user->id }}" id="user_{{ $user->id }}" {{ in_array($user->id, old('user_ids', [])) ? 'checked' : '' }}>
